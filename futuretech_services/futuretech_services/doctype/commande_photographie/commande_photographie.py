...
class CommandePhotographie(Document):
    ...
    def create_sales_invoice(self):
        ...
        existing_invoice = frappe.get_all(
            "Sales Invoice",
            filters={"commande_photographie": self.name}
        )
        if existing_invoice:
        ...
        invoice_data = {
            ...
            "items": [
                {
                    "item_name": self.type_d_impression,  # ou item_code si tu as un Item
                    "qty": self.quantite,
            ...
            "commande_photographie": self.name  
        }
